...
# %w[Action Comedy Drama Romance Thriller Fantasy Documentary Adventure Animation
#    Sci-Fi].each do |genre|
#   Genre.create!(name: genre)
# end

User.create!(name: 'Tim', email: 'tim@tim.com', username: 'tim', password: 'tim', admin: true)
...
#   f = File.open(Rails.root.join("app/assets/images/#{filename}"))
#   m.main_image.attach(io: f, filename:)
# end
